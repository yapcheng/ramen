  ...
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7 p-10 rounded-xl ">
        ...
        <div className=" bg-amber-50 rounded-3xl shadow-xl py-5">
               ...
               <img src={raman.image ||"/images/default-image.png" } alt={raman.name} className="w-full h-48 object-contain"/>
              </Link>
                ...
                <Link to={`/raman/${raman.id}`} >
                <p className=" flex text-[12px] mx-45 items-center justify-center texrt-center border-2 lg:mx-25 border-[#D9B87D] text-[#D9B87D] md:mx-10 ">More</p>
                </Link>
            </div>
